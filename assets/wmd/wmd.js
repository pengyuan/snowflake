...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>输入图片URL链接.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>例如:<br />http://wmd-editor.com/images/cloud1.jpg   \"Optional title\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>输入链接地址.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>例如:<br />http://wmd-editor.com/   \"Optional title\"</p>";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			hrButton.title = "水平分割线 <hr> Ctrl+R";
